...
describe('Test de RUTAS', () => {
    ...
    describe('GET /rickandmorty/login', () => {
        it('Ruta de login retorna access true', async () => {
            const response = (await agent.get('/rickandmorty/login?email=palmierimayra@gmail.com&password=Henry10062')).body;
    ...
    it('Devuelve el arreglo enviado por los dos personajes', async () => {
    ...
    describe('DELETE /rickandmorty/fav/:id', () => {
        ...
        it('Devuelve los personajes existentes luego del id inválido', async () => {
            const response = (await agent.delete('/rickandmorty/fav/5555')).body;
            expect(response).toContainEqual(character1);
            expect(response).toContainEqual(character2);
        })
        it('Se elimina un personaje de favoritos de manera exitosa', async () => {
